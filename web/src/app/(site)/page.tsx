        ...
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          <div className="grid grid-cols-2 gap-3">
            {[
              ...
              { label: "Prazo máximo", value: "até 35 anos" },
              ...
              >
                ...
                <CardContent className="pt-5">
                  ...
                  <div className="flex gap-4 text-sm text-gray-500 border-t border-gray-100 pt-4 mb-5">
                    ...
                    {property.parking && <span>{property.parking} vaga{property.parking > 1 ? "s" : ""}</span>}
                  </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-gray-400 leading-relaxed mb-10">
                ...
                engenharia em Canaã dos Carajás - PA e região. Nossa equipe multidisciplinar
