      ...
      <div className="flex items-start justify-between gap-4 flex-wrap">
        <div>
          ...
          <p className="text-gray-400 text-sm mt-0.5">
            {contratos.length} contrato{contratos.length !== 1 ? "s" : ""} · Gestão de compra, venda e locação
          </p>
        </div>
      </div>
      ...
      <div className="bg-white border border-gray-100 p-5">
        ...
        <form action={criarContrato} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <div>
            ...
            <input name="parteA" type="text" required placeholder="Nome do vendedor" className="w-full border border-gray-200 px-3 py-2.5 text-sm focus:outline-none focus:border-[var(--brand-yellow)] bg-gray-50" />
          </div>
          <div>
          ...
          <div>
            ...
            <input name="parteB" type="text" required placeholder="Nome do comprador" className="w-full border border-gray-200 px-3 py-2.5 text-sm focus:outline-none focus:border-[var(--brand-yellow)] bg-gray-50" />
          </div>
          <div>
              ...
              {contratos.map((c) => {
                ...
                return (
                  <tr key={c.id} className="border-b border-gray-50 hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-4 py-3 text-gray-700 capitalize">{c.tipo.replace("_", " ")}</td>
                    ...
                    <td className="px-4 py-3 text-gray-500 text-xs">
                      {c.vencimento ? c.vencimento.toLocaleDateString("pt-BR") : "—"}
                    </td>
